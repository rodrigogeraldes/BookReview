   ...
   <body>
   	<%
		...
		while (resultSet.next()) {
			...
			id_nivel_usuario = resultSet.getInt("id_nivel_usuario");
		}
                        ...
                        <div class="frontside">
                            <div class="card">
                                <div class="card-body text-center">
                                    ...
                                    <p class="card-text">Charlie Donlea<br/></p>
                        ...
                        <div class="frontside">
                            <div class="card">
                                <div class="card-body text-center">
                                    ...
                                    <p class="card-text">Melissa Tobias<br/><span style="color: black; font-size: 16px; font-weight: bold;">R$ 95,00</span></p>
                                    <a href="#" class="btn btn-warning btn-sm"><i class="fa fa-plus"></i></a>
                                </div>
                            </div>
                        </div>
